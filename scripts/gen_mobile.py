...
<thead><tr><th>代码</th><th>基金</th><th>场内</th><th>涨跌</th><th>估净值</th><th>净值涨跌</th><th>溢价</th><th>误差</th></tr></thead>
<tbody id="sumBody"><tr><td colspan="8" style="text-align:center;padding:20px"><span class="spinner"></span> 加载中…</td></tr></tbody>
</table>
</div>
...
function render(results, log){
  ...
  for(const r of ranked){
    ...
    <td class="${cls(r.priceChg)}">${fmt(r.priceChg,2,'+')+'%'}</td>
    <td><b>${r.navEst.toFixed(4)}</b></td>
